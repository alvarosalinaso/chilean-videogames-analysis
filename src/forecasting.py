...
def run_forecasting(
    ...
    if len(yearly) >= 5:
        ...
        try:
            ...
            print(
                f"[FORECAST] ARIMA releases: 2026={forecast_arima.values[0]:.0f}, 2027={forecast_arima.values[1]:.0f}, 2028={forecast_arima.values[2]:.0f}"
            )
        ...
        try:
            ...
            print(
                f"[FORECAST] ES releases: 2026={forecast_es.values[0]:.0f}, 2027={forecast_es.values[1]:.0f}, 2028={forecast_es.values[2]:.0f}"
            )
        except Exception as e:  # noqa: BLE001
    ...
    if "gross_revenue_est_usd" in steam.columns and len(steam) >= 10:
        ...
        if len(rev_yearly) >= 5:
            ...
            try:
                ...
                print(
                    f"[FORECAST] ARIMA revenue: 2026=${forecast_rev.values[0]:,.0f}, 2027=${forecast_rev.values[1]:,.0f}"
                )
            except Exception as e:  # noqa: BLE001
