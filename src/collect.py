...
GAME_NAMES = [
    ...
    "Valiants: Arena",
    "Microlandia",
    "BALSEO: The Sea Beyond",
    "Isekai Guild",
    "Re:Agent",
    "WAFIEU",
    "SAI: Servicio de Auxilio Inmediato",
    "Stick Out!",
    "Colorbound",
    "Gallery of Shadows – Lycans Returns",
    "Elemental Wizards",
    "The Eightfold Path",
    "Space Evolver",
    "Chromatic Battles",
    "Kami’s Garden: Bound To The Pages",
    # Page 2
    "ZOMBI ROCKSTAR",
    "Virus Blast",
    ...
    "Tormented Souls 2",
    "Hybrid Blood",
    "Jumpy Paws – World Adventures",
    "Avoidthis",
    "Hoverise Rebellion",
    "Oriontis",
    "Aura: Echoes of Pain",
    "Crystal Crepes: Tales of Food and Magic",
    "Stop, Pawssport Check",
    "PaRoKuuu",
    ...
    "UNGALAND!",
    "Arm Around!",
    "Soul Catcher: The Moon Coliseum",
    "Daybreak Slam",
    "Cosmic Horror Tales: Roots Below",
    "Ink of Fate",
    "Scalpel, Please!",
    "Mecha Survivors",
...
def search_steam_id(game_name):
    ...
    try:
        ...
        for res in results:
            ...
            if (
                not q_tokens.intersection(t_tokens)
                and game_name.lower() not in title.lower()
                and title.lower() not in game_name.lower()
            ):
                logger.debug(
                    f"  [Descartado] '{title}' (AppID: {appid}) no coincide con '{game_name}'"
                )
                continue
